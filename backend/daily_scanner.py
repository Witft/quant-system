...
TECH_WATCHLIST = [
    ...
    # --- 新增扩充 ---
    {"symbol": "TSLA", "name": "特斯拉", "market": "US", "theme": "自动驾驶/机器人/新能源"},
    {"symbol": "SMCI", "name": "超微电脑", "market": "US", "theme": "AI服务器"},
    {"symbol": "DELL", "name": "戴尔", "market": "US", "theme": "AI PC/端侧设备"},
    {"symbol": "HPQ", "name": "惠普", "market": "US", "theme": "AI PC/端侧设备"},
    {"symbol": "CRWD", "name": "CrowdStrike", "market": "US", "theme": "AI网络安全"},
    {"symbol": "PANW", "name": "Palo Alto", "market": "US", "theme": "云安全/防火墙"},
    {"symbol": "SNOW", "name": "Snowflake", "market": "US", "theme": "云数据仓库/AI数据底座"},
    {"symbol": "NOW", "name": "ServiceNow", "market": "US", "theme": "企业级AI服务/SaaS"},
    {"symbol": "CRM", "name": "赛富时", "market": "US", "theme": "AI CRM/SaaS"},
    {"symbol": "MU", "name": "美光科技", "market": "US", "theme": "HBM高带宽内存"},
    {"symbol": "INTC", "name": "英特尔", "market": "US", "theme": "x86架构/芯片代工"},
    {"symbol": "AMAT", "name": "应用材料", "market": "US", "theme": "核心半导体设备"},
    {"symbol": "LRCX", "name": "泛林集团", "market": "US", "theme": "核心半导体设备"},
    {"symbol": "PDD", "name": "拼多多", "market": "US", "theme": "电商出海/下沉市场"},
    {"symbol": "JD", "name": "京东", "market": "US", "theme": "电商/供应链"},
    {"symbol": "BIDU", "name": "百度", "market": "US", "theme": "AI大模型/自动驾驶"},
    {"symbol": "NTES", "name": "网易", "market": "US", "theme": "游戏出海/AI应用"},
    {"symbol": "9868.HK", "name": "小鹏汽车", "market": "HK", "theme": "高阶智驾/新能源"},
    {"symbol": "2015.HK", "name": "理想汽车", "market": "HK", "theme": "新能源/增程造车"},
    {"symbol": "NIO", "name": "蔚来", "market": "US", "theme": "高端纯电/换电网络"},
    {"symbol": "MSTR", "name": "MicroStrategy", "market": "US", "theme": "比特币资产映射"},
    {"symbol": "COIN", "name": "Coinbase", "market": "US", "theme": "加密资产交易"},
]
...
2. 🧐 【F-Score 审计师】：基于上方给出的财务数据和皮奥特罗斯基(Piotroski) F-Score 理念，选出你认为最关键的 2 个指标，列出它们的当前值，并说明这些值是否令人担忧。优先从以下 F-Score 核心指标中选取：经营现金流(每股)、净利润同比增长、销售毛利率、ROA、流动比率、速动比率、资产负债率。格式示例：「① 经营现金流(每股)：X元 → 说明… ② 毛利率：X% → 说明…」。如果这些细分指标大部分缺失（如银行股），请明确说明"该行业F-Score细分指标不适用"，并改用ROE和负债率进行分析。
